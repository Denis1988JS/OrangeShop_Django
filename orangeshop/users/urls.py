...
urlpatterns = [
    ...
    path('edit_user/<int:pk>',EditUserProfile.as_view(), name='edit_user'),#Страница редактирования пользователя
    path('logout/', LogoutView.as_view(), name='logout'),#Выход с сайта
]