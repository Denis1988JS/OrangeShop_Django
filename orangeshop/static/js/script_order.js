...
let courier_or_post = `<div class="courier_or_post_delivery">
	<div class="item_body">
		<input type="text" id="full_name"  name="fullNameUser" class="form_imput_adress full_name" placeholder="ФИО получателя" value="" />
	</div>
	<div class="item_body">
		<label for="tell" class="label_block">+7</label>
		<input type="tel" id="tell" name="phone" class="form_imput_tell phone" placeholder="Телефон" value="" />
	</div>
	<div class="item_body">
		<input type="text" id="street" name="streetName" class="form_imput_street street" placeholder="Улица" value="" />
	</div>
	<div class="item_body">
		<div class="item_body_flex">
			<input type="text" id="ind_city" name="indexNumber" class="form_imput_street ind_city" placeholder="Индекс" value="" />
			<input type="text" id="home" name="streetNumber" class="form_imput_street home" placeholder="Дом" value="" />
			<input type="text" id="flat" name="numberApartment" class="form_imput_street flat" placeholder="Квартира" value="" />
		</div>
	</div>
</div>`
...
let postamat = `<div class="postamat_delivery">
									<div class="street_seach_block">
										<input type="text" id="map_street" name="adresPostmat" class="map_street" placeholder="Улица  или станция метро" value="" />
										<button class="seach_street_btn" value='1'>

										</button>
									</div>
									<img src="/static/images/makeOrder/map.svg" alt="Карта" class="map_block">
								</div>`

// 1 Если Курьерская или почта то блок courier_or_post_delivery 
$("#radio_delivery, #radio_delivery_1").on('click', function (e) {
	console.log('ok1')
	let target = e.target
...
$('#radio_delivery_2').on('click', function (e) {
	console.log('ok1')
	let target = e.target
	if (target['checked'] == true) {
		$('.adres_list').children('.courier_or_post_delivery , .postamat_delivery').empty()
...
$('#id_city_delivery').autocomplete({
	dataSource: cityList,
	valueProperty: 'region',
	textProperty: 'city',
...
$('input[name="methodPay"]').on('click', function (e) {
